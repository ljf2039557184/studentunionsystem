...
function addTable(pageInfo){
    ...
    $.each(pageInfo.list, function(index, obj){
        ...
        $('#tbodys').append(
            ...
            '<td>'+obj.fileName+'</td>'+
            '<td>'+obj.stuDepartment+'</td>'+
            '<td>'+obj.fileDate+'</td>'+
            '<td><a href="../file_downloads?fileName='+obj.fileName+'">下载</a> </td>'+
            '<td><button name="select-btn" class="btn btn-info select-btn btndelete" value="" data-id="'+obj.did+'" data-filter-name="'+obj.fileName+'">删除</button></td>'+
            '</tr>'
